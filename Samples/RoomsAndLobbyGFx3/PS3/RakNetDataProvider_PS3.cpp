...
RakNetDataProvider_PS3::RakNetDataProvider_PS3()
{
...
UPInt RakNetDataProvider_PS3::GetTotalServerCount(LobbyServer::NetworkType net)
{
	return 0;
}
void RakNetDataProvider_PS3::SetExternalInterfaces(const RakNetDataProviderExternalInterfaces &externalInterfaces)
{
...
void RakNetDataProvider_PS3::Startup(void)
{
...
void RakNetDataProvider_PS3::Shutdown(void)
{
...
SInt RakNetDataProvider_PS3::Run()
{
...
void RakNetDataProvider_PS3::Tick(void)
{
	ProcessCommands();
...
void RakNetDataProvider_PS3::ProcessCommand(LDPCommand* cmd)
{
	switch (cmd->Type)
	{
...
void RakNetDataProvider_PS3::RN_ConnectUser(LDPCommand* cmd)
{
...
void RakNetDataProvider_PS3::ConnectToServer(ConnectionState newConnectionState)
{
...
void RakNetDataProvider_PS3::SendLoginMessage(void)
{
...
void RakNetDataProvider_PS3::RN_ConnectNewUser(LDPCommand* cmd)
{
	loginUsername=cmd->UserName;
	loginPassword=cmd->Password;
...
void RakNetDataProvider_PS3::SendRegisterAccountMessage(void)
{
...
void RakNetDataProvider_PS3::OnFailedConnectionAttempt(MessageID messageId, SystemAddress systemAddress)
{
...
void RakNetDataProvider_PS3::OnNewConnection(MessageID messageId, SystemAddress systemAddress)
{
	if (systemAddress==serverAddress)
	{
...
void RakNetDataProvider_PS3::AddServer(SystemAddress systemAddress, GPtr<LobbyServer> server)
{
	ServerMap.Add(systemAddress, server);
}
GPtr<LobbyServer> RakNetDataProvider_PS3::GetServer(SystemAddress systemAddress)
{
...
GPtr<LobbyServer> RakNetDataProvider_PS3::AllocOrGetServer(SystemAddress systemAddress, LDPResult **r, LobbyServer::NetworkType network)
{
...
void RakNetDataProvider_PS3::ClearServers(void)
{
	ServerMap.Clear();
}
int RakNetDataProvider_PS3::BuddyComp( RakString const &key, GPtr<LobbyBuddy> const &data )
{
	return strcmp(key.C_String(),data->GetName().ToCStr());
}
void RakNetDataProvider_PS3::AddBuddy(RakNet::RakString buddyName, GPtr<LobbyBuddy> buddy)
{
...
GPtr<LobbyBuddy> RakNetDataProvider_PS3::GetBuddy(RakNet::RakString buddyName)
{
...
void RakNetDataProvider_PS3::ClearBuddies(void)
{
	// BuddyMap.Clear();
	buddyList.Clear(false,__FILE__,__LINE__);
}
void RakNetDataProvider_PS3::OnDroppedConnection(Packet *packet)
{
...
void RakNetDataProvider_PS3::OnOfflinePong(Packet *packet)
{
...
const char* RakNetDataProvider_PS3::MessageIdToString(MessageID messageId) const
{
	switch (messageId)
	{
	case ID_CONNECTION_ATTEMPT_FAILED:
...
void RakNetDataProvider_PS3::MessageResult(Client_Login *message)
{
...
void RakNetDataProvider_PS3::MessageResult(Client_RegisterAccount *message)
{
	if (message->resultCode==L2RC_SUCCESS)
	{
		connectionState=NOT_LOGGED_IN;
...
void RakNetDataProvider_PS3::RN_Logout()
{
	RakNet::Client_Logoff *arg = (RakNet::Client_Logoff *) msgFactory->Alloc(L2MID_Client_Logoff);
	lobby2Client->SendMsgAndDealloc(arg);
}
void RakNetDataProvider_PS3::RN_GetBuddyInfo(LDPCommand* cmd)
{
}
void RakNetDataProvider_PS3::RN_SendMessage(LDPCommand* cmd)
{

}
void RakNetDataProvider_PS3::RN_AddBuddy(LDPCommand* cmd)
{
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_SendInvite *message)
{
	if (message->resultCode!=L2RC_SUCCESS)
	{
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_AcceptInvite *message)
{
	if (message->resultCode!=L2RC_SUCCESS)
	{
		LDPResult* r = new LDPResult(LDPResult::R_BuddyErrorReceived);
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_RejectInvite *message)
{
	if (message->resultCode!=L2RC_SUCCESS)
	{
		LDPResult* r = new LDPResult(LDPResult::R_BuddyErrorReceived);
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_Remove *message)
{
	if (message->resultCode!=L2RC_SUCCESS)
	{
		LDPResult* r = new LDPResult(LDPResult::R_BuddyErrorReceived);
...
void RakNetDataProvider_PS3::RN_PopulateServerList(LDPCommand* cmd)
{
...
void RakNetDataProvider_PS3::OnBuddyPanelStateChange(bool buddyPanelIsAvailable)
{
...
void RakNetDataProvider_PS3::RN_RefreshServer(LDPCommand* cmd)
{
...
void RakNetDataProvider_PS3::RN_StopUpdatingServerList(LDPCommand* cmd)
{
...
void RakNetDataProvider_PS3::MessageResult(Client_Logoff *message)
{
...
void RakNetDataProvider_PS3::DeleteBuddy(RakNet::RakString buddyName)
{
...
void RakNetDataProvider_PS3::PushBuddyOnlineStatus(RakNet::RakString buddyName, bool isOnline, const RakNet::Lobby2Presence &presence)
{
	LDPResult* r;
	GPtr<LobbyBuddy> buddy = GetBuddy(buddyName);
	if (! buddy.GetPtr())
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_GetFriends *message)
{
	unsigned int i;
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Friends_GetInvites *message)
{
	unsigned int i;
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Notification_Friends_StatusChange *message)
{
	switch (message->op)
	{
...
void RakNetDataProvider_PS3::MessageResult(RakNet::Notification_Friends_PresenceUpdate *message)
{
...
void RakNetDataProvider_PS3::SetBuddyPresence(LobbyBuddy* buddy, const RakNet::Lobby2Presence &presence)
{
	if (buddy)
	{
...
void RakNetDataProvider_PS3::RemoveBuddy(const LobbyBuddy* pbuddy)
{
...
void RakNetDataProvider_PS3::WriteTableToLobbyServer( DataStructures::Table *table, GPtr<LobbyServer> lobbyServer)
{
...
void RakNetDataProvider_PS3::WriteRoomCreationParametersToLobbyServer( CreateRoom_Func *callResult, GPtr<LobbyServer> lobbyServer)
{
...
void RakNetDataProvider_PS3::WriteRoomDescriptorToLobbyServer( RakNet::RoomDescriptor *roomDescriptor, GPtr<LobbyServer> lobbyServer)
{
...
void RakNetDataProvider_PS3::CreateRoom_Callback( SystemAddress senderAddress, CreateRoom_Func *callResult)
{
...
void RakNetDataProvider_PS3::SearchByFilter_Callback( SystemAddress senderAddress, SearchByFilter_Func *callResult)
{
	if (senderAddress!=serverAddress)
		return;
...
void RakNetDataProvider_PS3::GetRoomProperties_Callback( SystemAddress senderAddress, GetRoomProperties_Func *callResult)
{
	if (senderAddress!=serverAddress)
		return;
